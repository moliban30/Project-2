...
def generateName(colorList, animalList):
    ...
    while colorIdx < 0 or colorIdx > 5 or animalIdx < 0 or animalIdx > 5:
        colorIdx = input(' Choose a number between 0 and 5' )
        colorIdx = int(colorIdx)
        animalIdx = input(' Choose a number between 0 and 5' )
        animalIdx = int(animalIdx)
